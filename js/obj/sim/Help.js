...
class Help {
  constructor() {
    ...
    this.m_list = {
      ...
      equationContainer:"",
      hidebar:"Click arrow to expanded/hide questions", equationdiv:"",
      NernstEqn:"Current mode governing equation", GoldmanEqn:"Goldman equation",
      simulatorSetting:"In the setting Menu, you can change the setting of temperature and ion permeability", dataPlot:"Voltage data plot",
      answer:"Current Voltage in membrane", equilibrateButton:"Click this to equilibrate the membrane",
      secondBox:"",
      sim:"This window will deminstrate the movement of pparticles with the membrane</br>. You can either hover the window or press 'space' to pause the window", simulatorInputContainer:"",
      simInput:"All the particle input", particleControl:"All the particle control",
      helpDummy:""
    }
